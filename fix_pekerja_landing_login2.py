    ...
    <div style={{minHeight:"100vh",width:"100%",background:"#f8fafc",fontFamily:"'Plus Jakarta Sans',sans-serif"}}>
      ...
      <div style={{maxWidth:1280,margin:"0 auto",padding:"72px 48px 80px",display:"grid",
        ...
        <div style={{position:"relative",height:420,display:"flex",alignItems:"center",justifyContent:"center"}}>
          ...
          <div style={{position:"relative",zIndex:2,animation:"float1 4s ease-in-out infinite"}}>
            <svg width="220" height="300" viewBox="0 0 220 300" fill="none">
              ...
              <rect x="40" y="68" width="140" height="28" rx="2" fill="#374151"/>
              ...
              <circle cx="148" cy="82" r="8" fill="#1f2937"/>
          ...
          <div style={{position:"absolute",top:30,left:-10,animation:"float2 3.5s ease-in-out infinite",
            background:"#fff",borderRadius:14,padding:"14px 18px",boxShadow:"0 8px 32px #00000018",minWidth:170,zIndex:3}}>
          ...
          <div style={{position:"absolute",bottom:40,left:-10,animation:"float2 3.8s 1s ease-in-out infinite",
            background:"#fff",borderRadius:14,padding:"14px 18px",boxShadow:"0 8px 32px #00000018",minWidth:160,zIndex:3}}>
      ...
      <div style={{background:"#fff",borderTop:"1px solid #f1f5f9",padding:"32px 48px"}}>
      ...
      <div style={{textAlign:"center",padding:"24px",fontSize:12,color:"#94a3b8"}}>
        2026 <span style={{color:"#ea580c",fontWeight:700}}>Vista Teknik</span>. All rights reserved.
      </div>
    </div>
  );
}
...
NEW_LOGIN = r"""function Login({onLogin}:any){
  ...
  const selDc=(DIVISI_CONFIG as any)[div]||{};
...
# Fix fullscreen
old_body = '*{box-sizing:border-box;margin:0;padding:0}'
new_body = '*{box-sizing:border-box;margin:0;padding:0}html,body,#root{width:100%;height:100%;overflow-x:hidden}'
if old_body in content:
    content = content.replace(old_body, new_body)
    print("✅ Fullscreen CSS fixed")
else:
    print("⚠️  GCss body not found")
