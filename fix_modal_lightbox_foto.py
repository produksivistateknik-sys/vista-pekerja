...
with open(file_path + ".bak_modal_lightbox", "w", encoding="utf-8", errors="replace") as f:
    f.write(content)
...
if count == 1:
    ...
    with open(file_path, "w", encoding="utf-8", errors="replace") as f:
        f.write(content)
    print("[OK] Modal lightbox berhasil ditambah - klik foto untuk lihat ukuran penuh")
    print("[INFO] PENTING: cek apakah ada duplikat </div></div> penutup, perlu verifikasi build")
else:
