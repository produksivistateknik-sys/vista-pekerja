...
export function computeProsesStatus(progressMap:Record<string,number>|undefined|null,proses:string,relevantProses?:string[]):ProsesStatus{
  ...
  // vista-teknik/src/lib/panelHelpers.ts.
  // BUG FIX (20 Sep 2026, kasus nyata WM.3/Pintu box polyester WM_POLY) - gate ke RAKIT cuma
  // valid kalau RAKIT genuinely relevan buat kode ini. Komponen beli-jadi gak punya baris RAKIT
  // di bom_proses_relevan, progressMap["RAKIT"] PERMANEN 0 -> gate gak akan pernah kebuka, macet
  // "NOT YET" selamanya. Cermin dari fix yang sama di vista-teknik.
