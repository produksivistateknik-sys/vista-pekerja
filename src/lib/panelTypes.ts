...
// SYNC FIX (16 Sep 2026): 8 entry (FS.4/FS.9/F3B.2/F3B.3/F3B.8/F3B.11/WM.1/WM.2) masih bawa
// "BUSBAR" di sini padahal vista-teknik udah dibersihin sejak fix ghost-BUSBAR-badge 10 Sep 2026
// (4c464e1) - dorman selama ini karena ke-8 kombinasi kode+tipe itu kebetulan selalu punya baris
// bom_proses_relevan (jadi fallback ini gak kepake), TAPI kalau baris DB-nya suatu saat hilang
// (reset mapping, tipe_panel baru dst), fallback basi ini bakal balikin BUSBAR relevan lagi buat
// komponen mekanikal. Disamakan lagi ke vista-teknik + ditambah guard keras di
// isKomponenRelevant/getRelevantProsesForKode (bawah) biar gak cuma bergantung ke map ini.
