...
// Rotate PERMANEN foto/video (17 Sep 2026) - diduplikasi kecil dari vista-teknik (repo
// terpisah, gak bisa share modul, pola yang sama dipakai di file lain lintas-repo di project
// ini, mis. useWoEngineeringBroadcast, KOMPONEN_PROSES_MAP) - lihat komentar lengkap di
// vista-teknik/src/lib/mediaRotasi.ts & migration 20260917030000_media_rotasi.sql. File di R2
// TIDAK diubah, orientasi disimpan sbg METADATA (tabel media_rotasi, key by URL) - semua
// viewer baca ini & terapkan transform:rotate() pas render.
