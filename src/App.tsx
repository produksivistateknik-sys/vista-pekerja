...
function TrackingKomponenView({user}:any){
  ...
  return(
    <div style={{padding:16}} className="fi">
      ...
      <div style={{marginBottom:16,display:"flex",alignItems:"center",gap:12,background:"#fff",border:"1px solid #cbd5e1",borderRadius:12,padding:"12px 14px"}}>
    ...
    <div style={{minHeight:"100vh",background:"#f1f5f9"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",minHeight:"100vh"}}>
        ...
        <div style={{flex:1,overflowY:"auto"}}>
          {user.divisi==="nameplate"?<NameplateView user={user}/>:user.divisi==="qc"?<QCChecklistTab user={user}/>:user.divisi==="komponen"?<TrackingKomponenView user={user}/>:<OperatorView user={user}/>}
        </div>
